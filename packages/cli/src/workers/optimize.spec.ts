import { ColorGamut } from 'cepheus'
...
const CASE_A: OptimizeOptions = {
  ...
  colorGamut: ColorGamut.p3,
  colors: [
    [[0.571_320_822_154_189, 0.192_913_586_141_278_85, 257.107_067_678_695_05]],
    [[0.583_670_560_260_808_1, 0.196_072_988_796_713_45, 23.309_004_792_244_707]],
...
describe('./src/optimize.spec.ts', { timeout: 20_000 }, function () {
  it('case-a', async () => {
    const qwe = await optimize(CASE_A)
